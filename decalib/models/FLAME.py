...
class FLAME(nn.Module):
    ...
    def forward(self, shape_params=None, expression_params=None, pose_params=None, eye_pose_params=None, neck_pose=None):
        """
            Input:
        ...
        full_pose = torch.cat([pose_params[:, :3], neck_pose.expand(batch_size, -1).cuda(), pose_params[:, 3:], eye_pose_params], dim=1)
